...
const STATUS_FILTERS = [
  ...
  { label: "No disponible", value: "off_duty" },
];
...
export function DriverTable() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["drivers", { page, search, ordering, status }],
    queryFn: () => getDrivers({ page, search, ordering, status }),
  ...
  if (isError) {
    return <p className="text-sm text-destructive">Error al cargar conductores.</p>;
  }
